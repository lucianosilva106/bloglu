...
router.post("/categorias/edit", eAdmin, (req, res) => {
    Categoria.findOne({_id: req.body.id}).then((categoria) => {
        ...
        categoria.save().then(() => {
            ...
            req.flash("error_msg", "Houve um erro ao salvar edicao de categoria!")
        })
...
router.post("/categorias/deletar", eAdmin, (req, res) => {
    Categoria.deleteOne({_id: req.body.id}).then(() => {
        ...
        req.flash("error_msg", "Erro ao deletar categporia!")
        res.redirect("/admin/categorias")
...
router.get("/postagens/add", eAdmin, (req, res) => {
    Categoria.find().lean().then((categorias) => {
        ...
        req.flash("erro_msg", "Houve um erro ao carregar categorias para o formulario")
        res.redirect("/admin")
    })
})
...
router.post("/postagens/nova", eAdmin, (req, res) => {
    ...
    if(erros.length > 0){
        ...
        new Postagem(novaPostagem).save().then(() => {
            ...
            res.redirect("/admin/postagens", {postagens: postagens})
        }).catch((error) => {
...
router.get("/postagens/edit/:id", eAdmin, (req, res) => {
    Postagem.findOne({_id: req.params.id}).lean().then((postagem) => {
        ...
        req.flash("error_msg", "Houve um erro ao carregar o formularrio de edicao!")
        res.redirect("/admin/postagens")
    })
})
